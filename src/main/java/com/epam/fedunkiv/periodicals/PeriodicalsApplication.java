...
//                            , "true", LocalDateTime.now().withNano(0).toString(),
...
//                            "Science, also widely referred to as Science Magazine, is the peer-reviewed academic journal of the American Association for the Advancement of Science (AAAS) and one of the world's top academic journals.", "true",
//                            LocalDateTime.now().withNano(0).toString(),
//                            LocalDateTime.now().withNano(0).toString());
...
//                            "Advanced Materials is a weekly peer-reviewed scientific journal covering materials science. It includes communications, reviews, and feature articles on topics in chemistry, physics, nanotechnology, ceramics, metallurgy, and biomaterials.", "true",
//                            LocalDateTime.now().withNano(0).toString(),
//                            LocalDateTime.now().withNano(0).toString());
...
//                            "Forbes is an American business magazine owned by Integrated Whale Media Investments and the Forbes family. Published eight times a year, it features articles on finance, industry, investing, and marketing topics. ", "true",
//                            LocalDateTime.now().withNano(0).toString(),
//                            LocalDateTime.now().withNano(0).toString());
...
//                            "Fashion is a Canadian fashion magazine published by St. Joseph Communications. Established in 1977, it is currently based in Toronto (with satellite offices in Vancouver, Calgary and Montreal), publishes 10 issues a year and has a total readership of 1.85 million (PMB Oct 2010).", "true",
//                            LocalDateTime.now().withNano(0).toString(),
//                            LocalDateTime.now().withNano(0).toString());
...
//                            "PUMP Magazine was created by artists for artists. Established in December of 2013, PUMP is an esteemed international fashion and beauty lifestyle publication circulating through countless major fashion capitals and communities around the world.", "true",
//                            LocalDateTime.now().withNano(0).toString(),
//                            LocalDateTime.now().withNano(0).toString());
...
//                            "Nature is a British weekly scientific journal founded and based in London, England. As a multidisciplinary publication, Nature features peer-reviewed research from a variety of academic disciplines, mainly in science and technology. It has core editorial offices across the United States, continental Europe, and Asia under the international scientific publishing company Springer Nature.", "true",
//                            LocalDateTime.now().withNano(0).toString(),
//                            LocalDateTime.now().withNano(0).toString());
